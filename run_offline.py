...
def parse_args():
    ...
    parser.add_argument('--network', type=str, default =
                        'logs/220331_1348_Training_cornell_IW_0.8_RGB_Linear_adam/epoch_14_iou_0.88',
                        help='Path to saved network to evaluate')
    parser.add_argument('--rgb_path', type=str, default='cornell/01/pcd0173r.png',
                        help='RGB Image path')
    parser.add_argument('--depth_path', type=str, default='cornell/10/pcd1001d.tiff',
                        help='Depth Image path')
    parser.add_argument('--bb_path', type = str, default = 'cornell/01/pcd0173cpos.txt',
                        help = 'Bounding box path')
    ...
    parser.add_argument('--save', type=int, default=0,# 修改
...
if __name__ == '__main__':
    ...
    img_data = CameraData(include_depth=args.use_depth, include_rgb=args.use_rgb, path = args.bb_path)
